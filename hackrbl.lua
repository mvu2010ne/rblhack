-- MV Hub | Axiom Build v6.5
-- ALL FEATURES: ESP Distance, Tracers, Auto Farm Select, Horizontal Menu, Movable Icon
-- FIXED: Noclip, Fly, Super Jump, Icon Click + Drag
            ...
            if name:find("npc") or name:find("mob") or name:find("boss") or name:find("enemy") or name:find("marine") or name:find("pirate") or name:find("bandit") then
                ...
                if humanoid and humanoid.Health > 0 then
                    ...
                    if root then
                        ...
                        if levelMatch then level = tonumber(levelMatch) or 0 end
...
local function CreateUI()
    ...
    Title.Text = "⚡ MV HACK v6.5 - All Features"
    Title.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title.TextScaled = true
    Title.Font = Enum.Font.GothamBold
    Title.BorderSizePixel = 0
...
print("⚡ MV HACK v6.5 LOADED - All Features: ESP Distance, Tracers, Auto Farm Select, Horizontal Menu, Movable Icon - Boss man, fuck yeah!")